...
class Product extends Component {
    ...
    imageUrl="https://buffer.com/cdn-cgi/image/w=1000,fit=contain,q=90,f=auto/library/content/images/size/w600/2020/05/Frame-9.png"
    count = 5;
    state={
    ...
    render() {
        ...
        return (
            <div>
                ...
                <button onClick={this.handleDecrement} className='m-2 text-info btn btn-sm btn-warning'>-</button>
                <button onClick={this.handleDelete} className='m-2 text-info btn btn-sm btn-danger'>delete</button>
                <ul>
