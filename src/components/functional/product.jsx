...
const  Product= ({productName,count:countPro,children,id}) => {
    ...
    return (
        <>
            ...
            <button onClick={handleDecrement} className='m-2 text-info btn btn-sm btn-warning'>-</button>
            <button onClick={handleDelete} className='m-2 text-info btn btn-sm btn-danger'>delete</button>
            {children}
        </>
    );
